...
const TabNavigation = () => {
  ...
  const isOnMinimalPage = isOnSettingsPage || isOnProfilePage;
        ...
        <div className="tab-navigation__header">
          <div className="container">
            ...
            <div className="actions">
              {!isOnActivityPage && !isOnMinimalPage && (
                <>
                  <ArchiveButton
              ...
              {isOnActivityPage && currentActivity && (
                ...
                >
                  <i className={currentActivity.is_archived ? 'bi bi-arrow-counterclockwise' : 'bi bi-archive-fill'}></i>
